...
//
// **カレンダーは持たない。** 計画は「どの日が半日取引日か」「どの日が休場か」を述べておらず
// （feedback/20260804_fr20-stage1-session-calendar.md で環流済み）、
// ADR-0022 決定3 も別件で「営業日カレンダーを保持しない」と裁定している。
...
public static class Stage1SessionHypotheses
{
    ...
    /// この非対称が上述の「塞げない穴」であり、握り潰さずに記録している。
    /// </para>
    /// </summary>
