...
public sealed class RiskSettingsRow
{
...
public sealed class KillSwitchRow
{
    public int Id { get; set; } = SingletonKeys.Id;
...
public sealed class LockoutRow
{
    public int Id { get; set; } = SingletonKeys.Id;
...
public sealed class SettingsChangeRow
{
...
public sealed class ApprovedOrderRow
{
...
public sealed class TradeFillRow
{
...
public sealed class StageTransitionRow
{
...
public sealed class StagePerformanceRow
{
    public int Id { get; set; } = SingletonKeys.Id;
...
public sealed class WithdrawalNotificationRow
{
    public int Id { get; set; } = SingletonKeys.Id;
...
public sealed class PositionDriftStateRow
{
    public int Id { get; set; } = SingletonKeys.Id;
...
public sealed class OrderActivityRow
{
    public Guid DecisionId { get; set; }
...
public sealed class OrderScreeningObservationRow
{
    public Guid DecisionId { get; set; }
...
public sealed class Stage1FillObservationRow
{
    public Guid DecisionId { get; set; }
...
public sealed class Stage1SessionUptimeRow
{
...
public sealed class BuyInInferenceRow
{
    public Guid Id { get; set; }
...
public sealed class GoodFaithViolationRow
{
...
public sealed class PositionObservationDayRow
{
...
public sealed class GoodFaithViolationClearanceRow
{
...
public sealed class BorrowFeeAccrualRow
{
    public string Symbol { get; set; } = string.Empty;
...
public sealed class BorrowFeeUnavailableDayRow
{
    public string Symbol { get; set; } = string.Empty;
