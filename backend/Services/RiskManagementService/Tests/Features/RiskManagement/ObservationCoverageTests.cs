...
//
// 計画（FR-21・2026-08-08 改定・裁定 planning#292）が名指しした 2 つの失敗モードを塞ぐ。
...
public class ObservationCoverageTests
{
    ...
    private sealed class IBusinessCalendarStub : RiskManagementService.Features.RiskManagement.IBusinessCalendar
    {
