...
public static class FxRateSourceFactory
{
    ...
    /// </summary>
    public static TimeSpan ResolveMaxRateAge(FxOptions options)
    {
        ArgumentNullException.ThrowIfNull(options);
    ...
    /// </summary>
    public static TimeSpan ResolveStaleRateWarning(FxOptions options)
    {
        ArgumentNullException.ThrowIfNull(options);
