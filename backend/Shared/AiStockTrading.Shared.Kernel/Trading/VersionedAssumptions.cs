...
// AI 判断）は Version つきで共通参照する（IADR-0021/0063）。消費側が設定サービスへ依存せず参照できるよう共有カーネルに置く
// （IADR-0264 決定 2。旧 ConfigurationService.Domain から移送。IADR-0063 決定 3 の共有クライアント経由の参照は廃止した）。
