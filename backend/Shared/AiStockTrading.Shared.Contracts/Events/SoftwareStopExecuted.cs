...
//   🔴 #833 項目2, IADR-0344 追記(14): 打ち切りではない。到達の記録は残り、行ごとの待ち時間（30 秒から倍々・最大 15 分）を置いて
...
public enum SoftwareStopOutcome
{
    ...
    /// 撃ち直しは待ち時間を置いて続く（#833 項目2, IADR-0344 追記(14)）。
    /// </summary>
    CloseRejected = 2,
    ...
    /// 1 株も約定しなかった再武装は続けて売れなかった 1 回として数え、行ごとの待ち時間の後になる（#833 項目2, IADR-0344 追記(14)）。
