...
namespace AiStockTrading.Shared.Contracts.Tests
{
    ...
    public class EventMessageUrnTests
    {
        ...
        [InlineData(typeof(BrokerPositionsObserved), "urn:message:AiStockTrading.Shared.Contracts.Events:BrokerPositionsObserved")]
        ...
        [InlineData(typeof(PositionCloseRequested), "urn:message:AiStockTrading.Shared.Contracts.Events:PositionCloseRequested")]
        [InlineData(typeof(PositionReconciliationDrift), "urn:message:AiStockTrading.Shared.Contracts.Events:PositionReconciliationDrift")]
