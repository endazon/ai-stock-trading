...
| `adr-index-addendum-loss` | `check-adr-index-addendum-loss.js --self-test` と本検査（索引行の日付つき追記ブロックの消失。`fetch-depth: 0` が必要。#875） |
