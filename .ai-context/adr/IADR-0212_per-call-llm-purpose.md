...
> - AST 側は本追記と同日、[IADR-0278](IADR-0278_enable-screening-default-and-config-loader-baseline.md) により
...
> - **現行の既定値は IADR-0278 を正とする。** 本 IADR の決定1〜4（purpose の呼び出しごと引数化・egress
