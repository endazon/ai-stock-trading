...
> 本 IADR は **0.15 採用の一次記録**である。当時の計画（ADR-0008（計画リポ））は
...
>
> ADR-0018 決定2（計画リポ）（2026-08-01）は
...
- [IADR-0043](IADR-0043_backtest-foundation.md)、[IADR-0044](IADR-0044_overfitting-correction.md)、[FR-20 機能仕様](../../docs/functional/FR-20_staged-gates.md)
