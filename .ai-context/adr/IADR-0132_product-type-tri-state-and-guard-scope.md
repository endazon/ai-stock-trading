...
> feedback/20260804_fr19-guard-scope.md（環流記録）（論点 1・論点 2）で
> 計画へ環流した。
>
...
> [禁止銘柄の一時解除 Runbook](../../docs/operations/banned-symbol-unlock-runbook.md) を正とする。
...
> 更新または参照追記を feedback/20260804_fr19-guard-scope.md（環流記録）
> （論点 3）で求めた。
...
- 仕様書: [作業仕様書 20260804_332](../specs/20260804_332_trading-guards.md)・
  [機能仕様書 FR-19](../../docs/functional/FR-19_trading-guard.md)・
