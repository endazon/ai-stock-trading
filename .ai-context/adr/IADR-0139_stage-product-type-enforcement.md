...
段階ゲートが課す強制は範囲外だった（[FR-20 テスト仕様書](../../docs/tests/FR-20_staged-gates-tests.md)も
...
planning#179 の裁定により、**段階別の商品種別強制の適用範囲は「新規建てのみ」**である
...
- 計画: ADR-0016 決定8・決定14（計画リポ）／
  05_trading-assumptions §5（計画リポ）「取引可能な商品種別」「空売りの実弾解禁条件」／
  06_daytrading-review §4（計画リポ）
...
- 仕様書: [作業仕様書 20260804_333](../specs/20260804_333_stage-gate.md)／
  [FR-19 機能仕様書](../../docs/functional/FR-19_trading-guard.md)／[FR-20 テスト仕様書](../../docs/tests/FR-20_staged-gates-tests.md)
