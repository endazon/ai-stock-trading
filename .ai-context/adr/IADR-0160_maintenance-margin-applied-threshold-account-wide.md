...
- 環流: feedback/20260804_uc06-maintenance-ratio-formula.md（環流記録）（本追記の起点）／
  feedback/20260807_adr0016-margin-long-maintenance-threshold.md（環流記録）（本 ADR が新たに起こしたもの）
...
決定1・決定2）は安全側で仮置きし環流した（planning#214）。2026-08-07 に裁定が下りた。
