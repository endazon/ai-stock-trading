...
- 関連する計画書 ID: **FR-19**（取引ガード）／**FR-10**（リスク統制）／**FR-11**（監査ログ）／UC-06／
  **ADR-0025（計画リポ） 決定1・決定2・決定3**／
  ADR-0021（計画リポ） 決定4-2・4-3・4-5／
  ADR-0019（計画リポ） PoC 項目 8
- 関連する実装仕様書: [作業仕様書 20260807_425](../specs/20260807_425_gfv-self-counting.md)／
  [機能仕様書 FR-19](../../docs/functional/FR-19_trading-guard.md)／[テスト仕様書 FR-19](../../docs/tests/FR-19_trading-guards-tests.md)
...
いずれも存在しない）がそのまま計画へ採り入れられ、2026-08-07 に ADR-0025（計画リポ） で決着した。
...
- **計画へ環流する**（feedback/20260807_adr0025-gfv-counting-open-points.md（環流記録））。
...
- Superseded by: なし
- 計画への環流: feedback/20260807_adr0025-gfv-counting-open-points.md（環流記録）
