...
- 関連する実装仕様書: [20260711_backtest-foundation](../specs/20260711_backtest-foundation.md)、機能仕様 [FR-15_backtest](../../docs/functional/FR-15_backtest.md)
...
- 計画: FR-15/FR-20（要求（計画リポ））、ADR-0008（計画リポ）、06_daytrading-review §3.2/§4
