---
title: IADR-0283 k8s-local-deploy.sh は broker.tier/opend.enabled を個別に前回値へ引き継ぎ、KB レルム名を platform へ是正する
type: impl-adr
status: Accepted
...
# IADR-0283: k8s-local-deploy.sh は broker.tier/opend.enabled を個別に前回値へ引き継ぎ、KB レルム名を platform へ是正する
