...
- 計画上の禁止対象（06_daytrading-review §2.3（計画リポ））:
...
- 機能仕様: [FR-19_trading-guard](../../docs/functional/FR-19_trading-guard.md)。テスト仕様: [FR-19_manipulation-detection-tests](../../docs/tests/FR-19_manipulation-detection-tests.md)。
