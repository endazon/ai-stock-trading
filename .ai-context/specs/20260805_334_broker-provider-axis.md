...
related_specs:
  ...
  - ../../docs/functional/FR-12_paper-trade.md
  - ../../docs/tests/FR-20_staged-gates-tests.md
  - ../../docs/tests/FR-12_paper-trade-tests.md
  - ../../docs/tests/README.md
  - ../../docs/DEFINITION_OF_DONE.md
  - 20260804_333_stage-gate.md
  - feedback:20260805_fr20-broker-provider-open-points
---
...
- 計画書リンク: INDEX 決定 46（計画リポ） ／
  05_screens「運用段階（Stage）と発注先（Broker Provider）の表示規約（共通）」（計画リポ） ／
  02_requirements FR-12 / FR-13 / FR-20（計画リポ） ／
  06_daytrading-review §4.1・§4.2（計画リポ）
...
環流記録 20260805_fr20-broker-provider-open-points（環流記録） に
起票した（送付は未実施）。
