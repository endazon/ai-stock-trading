...
- 環流: feedback/20260804_uc06-maintenance-ratio-formula.md（環流記録）
  （本追記はこの環流＝project-planning#214 への裁定である）／
  **本作業で新たに feedback/20260807_adr0016-margin-long-maintenance-threshold.md（環流記録） を起こす**
...
テスト仕様書 [FR-10_risk-controls-tests](../../docs/tests/FR-10_risk-controls-tests.md) に
