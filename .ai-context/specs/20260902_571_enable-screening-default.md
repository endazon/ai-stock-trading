...
- 対象（本リポジトリ = AST）:
  ...
  - `.ai-context/adr/IADR-0272_...`（本作業の決定を記録する新規 IADR）
...
5. `.ai-context/adr/IADR-0272_...`（新規）: 本判断（判断1〜3）を記録する。
6. `.ai-context/adr/README.md` の索引へ IADR-0272 の行を追加。
...
- [ ] IADR-0212 に日付付き改訂節、IADR-0272 が新規決定を記録し、索引に反映される
