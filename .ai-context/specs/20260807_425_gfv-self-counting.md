...
- 関連 ADR: **ADR-0025（計画リポ） 決定1・決定2・決定3**（`Accepted`・2026-08-07・質問票 第 13 回 Q8-2）／
  ADR-0021（計画リポ） 決定4-2・4-3・4-5／
  ADR-0019（計画リポ） PoC 項目 8（本作業の対象外）
...
- 対象 Issue: [#425](https://github.com/endazon/ai-stock-trading/issues/425)（由来: #375・環流 feedback/20260806_adr0021-rejection-reasons-and-settled-cash.md（環流記録））
...
- 機能仕様書: [FR-19 取引ガード](../../docs/functional/FR-19_trading-guard.md)
- テスト仕様書: [FR-19 取引ガード](../../docs/tests/FR-19_trading-guards-tests.md)
