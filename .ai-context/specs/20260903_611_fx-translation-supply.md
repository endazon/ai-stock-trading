...
type: spec
status: review
related_ids: [FR-06, FR-16, FR-10, FR-17, UC-05, ADR-0022, IADR-0107, IADR-0152, IADR-0194, IADR-0197, IADR-0250, IADR-0251, IADR-0271, IADR-0286]
...
- 本作業の実装ADR: [IADR-0286](../adr/IADR-0286_fx-translation-supply-recognition-rate-and-period-end-rate.md)
...
> 本仕様書と IADR-0286 のぶん **+2** される（例: 軸 1 は 12 → 14）。**値はコミットで固定する。**
...
- USD 現金残高に対する為替差損益（入出金の取得レート）は台帳が持たず、本作業の対象外（残余リスクとして IADR-0286 に記す）。
