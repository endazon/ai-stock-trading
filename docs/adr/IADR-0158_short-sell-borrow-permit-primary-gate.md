...
- 計画書 ID: **[ADR-0016](../../planning/projects/ai-stock-trading/07_adr/ADR-0016_short-selling-staged-release.md) 決定3（2026-08-06 改訂）**（本 IADR の直接の起点。環流 endazon/project-planning#204）／
  同 決定10（拒否理由 9 種・すべてクラス A）／同 決定14（Stage 1 で検証できない統制）／
  [ADR-0019](../../planning/projects/ai-stock-trading/07_adr/ADR-0019_moomoo-poc-margin-paper-account.md) 決定1 項目3（実測の出所）／**FR-10**・UC-06・FR-15 / FR-17（費用計算＝接続しない側）
...
- 機能 / テスト仕様書: [FR-10 機能仕様書](../functional/FR-10_risk-controls.md)・[FR-10 テスト仕様書](../tests/FR-10_risk-controls-tests.md)
...
- Superseded by: なし
- 環流: [feedback/20260807_adr0016-shortfeerate-unit-and-borrow-supply.md](../../feedback/20260807_adr0016-shortfeerate-unit-and-borrow-supply.md)
