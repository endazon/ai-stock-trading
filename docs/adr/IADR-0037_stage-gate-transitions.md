---
title: IADR-0037 段階遷移は承認ゲートを構造で強制し、撤退は「自動停止＋降格提案」に分離する（段階状態＝履歴の畳み込み）
type: impl-adr
status: Accepted
...
# IADR-0037: 段階遷移は承認ゲートを構造で強制し、撤退は「自動停止＋降格提案」に分離する（段階状態＝履歴の畳み込み）
...
- Supersedes: なし
- Superseded by: なし
- 関連: [ADR-0008](../../planning/projects/ai-stock-trading/07_adr/ADR-0008_staged-gates-and-backtest.md)、[IADR-0005](IADR-0005_stage-capital-cap-definition.md)、[IADR-0033](IADR-0033_shared-inventory-fold.md)
