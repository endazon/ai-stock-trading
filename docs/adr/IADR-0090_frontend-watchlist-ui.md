...
- 前提（develop マージ済み）: MarketMonitor `GET/POST/DELETE /monitor/watchlist`・`GET /monitor/watchlist/history`
  （OwnerOnly・[MonitorSettingsEndpoints.cs](../../backend/Services/MarketMonitorService/src/MarketMonitorService.Worker/Foundation/Endpoints/MonitorSettingsEndpoints.cs)・PR #195）
