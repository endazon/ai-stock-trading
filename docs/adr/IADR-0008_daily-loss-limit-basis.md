...
- 関連する実装仕様書: [20260709_risk-eval-core-fixes](../specs/20260709_risk-eval-core-fixes.md)、
  機能仕様書 [FR-10_risk-controls](../functional/FR-10_risk-controls.md)
- 対象 Issue: #31
- 対象コード: [`PortfolioSnapshot.cs`](../../src/Services/RiskManagementService/src/RiskManagementService.Domain/PortfolioSnapshot.cs)、
