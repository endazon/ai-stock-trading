...
計画（[FR-20](../../planning/projects/ai-stock-trading/02_requirements/01_requirements.md)）は次を定める。
...
計画（[05_screens](../../planning/projects/ai-stock-trading/05_screens/01_screens.md) SC-03）は
