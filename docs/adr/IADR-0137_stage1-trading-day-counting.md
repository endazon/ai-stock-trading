...
（[06_daytrading-review §4.1〜§4.3](../../planning/projects/ai-stock-trading/06_technical/06_daytrading-review.md)・
...
1. **半日取引日カレンダーを実装が持つ** — 判定は自己完結するが、**カレンダーの誤りがそのまま昇格判定の誤りに
   ...
   [ADR-0022 決定3](../../planning/projects/ai-stock-trading/07_adr/ADR-0022_fx-rate-source-and-freshness.md) は
...
- **計画が沈黙している論点で値を発明しない。** 半日取引日カレンダーの出どころは計画に無い。
  → [feedback/20260804_fr20-stage1-session-calendar.md](../../feedback/20260804_fr20-stage1-session-calendar.md) で計画へ環流する。
...
- 計画: [06_daytrading-review §4.1〜§4.3](../../planning/projects/ai-stock-trading/06_technical/06_daytrading-review.md)／
  [INDEX 決定 34・42](../../planning/projects/ai-stock-trading/INDEX.md)／
  [ADR-0022 決定3](../../planning/projects/ai-stock-trading/07_adr/ADR-0022_fx-rate-source-and-freshness.md)（カレンダーを持たない裁定の前例）
...
- 環流: [feedback/20260804_fr20-stage1-session-calendar.md](../../feedback/20260804_fr20-stage1-session-calendar.md)
