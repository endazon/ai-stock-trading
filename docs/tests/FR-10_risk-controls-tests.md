...
| 判定通貨を USD へ移した場合の等価性 | 移行の要否が未決（作業仕様書 未決事項 §1）。通貨非依存の不変条件（T-10-112）は固定済み | 未起票（#338 / #339 / #346 と範囲が重なる） |
...
- 作業仕様書: [20260804_330_maintenance-margin-auto-reduce](../specs/20260804_330_maintenance-margin-auto-reduce.md)（自動縮小）・
...
- 実装 ADR: [IADR-0133](../adr/IADR-0133_maintenance-margin-auto-reduce.md)・
