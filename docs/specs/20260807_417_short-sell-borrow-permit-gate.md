...
- 関連 ADR:
  **[ADR-0016](../../planning/projects/ai-stock-trading/07_adr/ADR-0016_short-selling-staged-release.md) 決定3（2026-08-06 改訂）**（本作業の直接の起点）／
  同 決定10（拒否理由 9 種・すべてクラス A・畳まない規律）／同 決定14（Stage 1 で検証できない統制の表）／
  [ADR-0019](../../planning/projects/ai-stock-trading/07_adr/ADR-0019_moomoo-poc-margin-paper-account.md) 決定1 項目3（実測の出所）
