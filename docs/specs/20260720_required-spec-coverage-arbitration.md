...
- CLAUDE.md / [docs/README.md](../README.md) は機能仕様書（`docs/functional/`・FR 単位）とテスト仕様書
...
| **FR-10** ★ | リスク統制（kill switch/日次損失/DD/連敗縮小/pause-resume 等） | Must | **必須 ✅** [FR-10](../functional/FR-10_risk-controls.md) | **必須 ✅** [FR-10 系](../tests/FR-10_risk-guard-core-tests.md) | [risk-guard-core](20260708_risk-guard-core.md) / [pause-resume](20260718_152_pause-resume.md) |
| FR-11 | 監査時系列ログ | Must | 任意 ― | 任意 ― | [audit-log](20260710_audit-log.md) / [audit-remaining-events](20260711_audit-remaining-events.md) |
| **FR-12** ★ | ペーパートレードモード | Should | **必須 ✅** [FR-12](../functional/FR-12_paper-trade.md) | **必須 ✅** [FR-10 系](../tests/FR-10_risk-guard-core-tests.md)（T-12-xx） | [paper-broker-validation](20260709_paper-broker-validation.md) |
...
| **FR-15** ★ | バックテスト＝実弾前の必須ゲート Stage 0 | Must | **必須 ✅** [FR-15](../functional/FR-15_backtest.md) | **必須 ➕** [FR-15](../tests/FR-15_backtest-tests.md)（本 PR で補完） | [backtest-foundation](20260711_backtest-foundation.md) / [verdict-supply](20260718_backtest-verdict-supply.md) |
...
| **FR-19** ★ | 取引ガード（禁止銘柄・差金決済防止・相場操縦禁止 等） | Must | **必須 ✅** [FR-19](../functional/FR-19_trading-guard.md) | **必須 ✅** [FR-19 相場操縦](../tests/FR-19_manipulation-detection-tests.md) ＋ [FR-10 系](../tests/FR-10_risk-guard-core-tests.md)（T-19-xx） | [risk-eval-core-fixes](20260709_risk-eval-core-fixes.md) / [manipulation-detector](20260711_manipulation-detector.md) |
| **FR-20** ★ | 段階ゲート（Stage 0〜3・モード/資金上限強制） | Must | **必須 ✅** [FR-20](../functional/FR-20_staged-gates.md) | **必須 ✅** [FR-10 系](../tests/FR-10_risk-guard-core-tests.md)（T-20-xx） | [stage-gate-transitions](20260718_20_stage-gate-transitions.md) |

### 裁定後の充足状況

- **機能仕様書（安全中核 5 FR）**: FR-10/12/15/19/20 = **5/5 実在**。
- **テスト仕様書（安全中核 5 FR）**: FR-10/12/19/20 は [FR-10 系テスト仕様書](../tests/FR-10_risk-guard-core-tests.md)が写像済み・
  FR-19 は[相場操縦テスト仕様書](../tests/FR-19_manipulation-detection-tests.md)も併存。**唯一欠けていた FR-15 を本 PR で補完**
  （[FR-15 テスト仕様書](../tests/FR-15_backtest-tests.md)）→ **5/5 充足**。
...
1. 本裁定の記録（本書）。
2. [FR-15 テスト仕様書](../tests/FR-15_backtest-tests.md)の新規作成（安全中核テスト仕様を 5/5 に）。
3. 規約の明確化: `CLAUDE.md`「仕様書」節および [docs/README.md](../README.md)「必須の仕様書」節に、機能/テスト仕様書の
...
- 規約: `CLAUDE.md`（本リポ・「仕様書」節）、[docs/README.md](../README.md)（「必須の仕様書」節）
- 機能仕様書: [FR-15 バックテスト](../functional/FR-15_backtest.md)
- テスト仕様書: [FR-15 バックテスト](../tests/FR-15_backtest-tests.md)、[FR-10/12/19/20 リスクガードコア](../tests/FR-10_risk-guard-core-tests.md)
