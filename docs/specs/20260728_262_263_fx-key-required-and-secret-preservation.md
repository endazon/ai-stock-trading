...
- 計画書: [05_trading-assumptions.md](../../planning/projects/ai-stock-trading/06_technical/05_trading-assumptions.md) §3
  （基準通貨 = JPY／レート取得元 = 日銀API または FRED）、
  [ADR-0004](../../planning/projects/ai-stock-trading/07_adr/ADR-0004_datasource-selection.md)（案A+ の無料ソース）
