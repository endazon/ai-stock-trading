...
related_specs:
  ...
  - ../tests/FR-19_trading-guards-tests.md
...
- 計画書リンク: [02_requirements FR-19](../../planning/projects/ai-stock-trading/02_requirements/01_requirements.md) ／
  [05_trading-assumptions §5](../../planning/projects/ai-stock-trading/06_technical/05_trading-assumptions.md) ／
  [06_daytrading-review §2](../../planning/projects/ai-stock-trading/06_technical/06_daytrading-review.md) ／
...
[feedback/20260804_fr19-guard-scope.md](../../feedback/20260804_fr19-guard-scope.md) 論点 1。**裁定待ち**）。
...
1. **市場ガード・禁止銘柄ガードの手仕舞い適用**（**環流済み・裁定待ち**）: `MarketDisabled` /
   ...
   それぞれの代償を併記して**裁定を仰いでいる**。実装は裁定まで現状（A）のまま。
...
4. **`06_daytrading-review` §2.2 の記述の陳腐化**（**環流済み・裁定待ち**）: 同節は「日本の差金決済禁止は
   ...
   （[feedback/20260804_fr19-guard-scope.md](../../feedback/20260804_fr19-guard-scope.md) 論点 3）。
...
| 2026-08-04 | 監査指摘により、ガードの適用範囲 3 論点を計画へ環流（[feedback/20260804_fr19-guard-scope.md](../../feedback/20260804_fr19-guard-scope.md)）。計画書との差異 1 と未決事項 1・4（新設）を「環流済み・裁定待ち」へ更新 |
...
- テスト仕様書: [FR-19 取引ガード（再実装）](../tests/FR-19_trading-guards-tests.md)・
  [FR-19 相場操縦パターン検知](../tests/FR-19_manipulation-detection-tests.md)
