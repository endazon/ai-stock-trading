...
[feedback/20260804_fr19-guard-scope.md](../../feedback/20260804_fr19-guard-scope.md) 論点 1。
...
1. **市場ガード・禁止銘柄ガードの手仕舞い適用**（**✅ 解決済み 2026-08-04**）: `MarketDisabled` /
   ...
   **手仕舞いが必要になったときの手順**は [禁止銘柄の一時解除 Runbook](../operations/banned-symbol-unlock-runbook.md) に定めた（#380）。
