...
- 関連: 機能仕様 [FR-10](../functional/FR-10_risk-controls.md)、データ仕様 [risk-management-aggregates](../data/risk-management-aggregates.md)
...
- 機能仕様: [FR-10 リスク統制](../functional/FR-10_risk-controls.md)
- データ仕様: [リスク管理ドメインの集約](../data/risk-management-aggregates.md)
- 通信仕様: [イベント・ポート契約](../api/events-and-ports.md)
