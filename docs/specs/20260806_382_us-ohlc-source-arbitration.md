...
計画 [ADR-0023](../../planning/projects/ai-stock-trading/07_adr/ADR-0023_us-daily-ohlc-history-source.md)（2026-08-04）が
...
[作業仕様書 20260805_342](20260805_342_moomoo-poc-plan.md) §項目 7・[blocked-tasks](../blocked-tasks.md) A-3）。
...
- **対象外**（計画側の裁定待ち。本 PR では手を付けない）
  - **moomoo を米国株日足 OHLC の履歴源として採用すること。** ADR-0023 は代替源を定めておらず、採用は
    ...
    [blocked-tasks](../blocked-tasks.md) B-4 に「ADR-0023 の改定裁定待ち」として登録済みである。**アダプタを実装しない**
