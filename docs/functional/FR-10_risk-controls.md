...
`GET /risk-controls/buy-in-inferences?from=&to=`（**`OwnerOrService`**）が**期間が観測に覆われているか（FR-21）と
...
## 借株料の累計（#465 / ADR-0027 / [IADR-0183](../adr/IADR-0183_borrow-fee-accrual-recording.md)）
