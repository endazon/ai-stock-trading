...
import type { ChangeEntry, TradingAssumptions, VersionedAssumptions } from '../types';
...
// **本 feature 以外はこの端点を消費しない**ため、共有層ではなく feature の中に置く（#529）。
//
// 型は `../types` が持ち、ここからは**再輸出しない**——画面が「取得の実装」を経由せずに型を得られる
// ようにするためであり、参照先を 1 つに保つ。
